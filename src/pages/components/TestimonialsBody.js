        ...
        <div className="testimonial left">
          <div className="text-container">
            <p>
              ...
              project. I appreciate you, sharing your expertise, listening
              attentively to my needs and preferences and demonstrating
              flexibility to ensure a beautiful and functional design, which not
              only enhances the main bedroom, but complements the rest of my
        ...
        <div className="testimonial left">
          <div className="text-container">
            <p>
              ...
              completed several kitchen and joinery projects with Core
              Interiors. They have become my joiner of choice, so much so that I
              had them install my own kitchen recently, for which I have
        ...
        <div className="testimonial right">
          <div className="text-container">
            <p>
              ...
              kitchen. We were impressed with your willingness in helping us
              decide on the colour to use on the cupboards, and then not
              complaining when we ended up painting them white! The project may
              have taken a little longer than we anticipated, but we know that
        ...
        <div className="testimonial left">
          <div className="text-container">
            <p>
              ...
              internationally my requirements are rigorous and often unusual and
              challenging. When recently I installed extensive new joinery work
              in my own apartment in Cape Town this requirement remained
              unchanged. Core Cabinets and Interiors paid proper attention to my
        ...
        <div className="testimonial left">
          <div className="text-container">
            <p>
              ...
              the manufacture and installation of a complete new kitchen and
              bedroom cupboards. The project was a good experience – Core were
              friendly, co-operative, honest, efficient, professional, cost
              effective and all workmanship was of the highest quality. As the
              project progressed there was flexibility to implement changes to
              improve upon the original design. We were able to have open and
        ...
        <div className="testimonial right">
          <div className="text-container">
            <p>
              ...
              understand my unique design requirements for my commissioned TV
        ...
        <div className="testimonial left">
          <div className="text-container">
            <p>
              ...
              came to redesigning our kitchen. We were very impressed with the
        ...
        <div className="testimonial right">
          <div className="text-container">
            <p>
              ...
              kitchen into a modern delight. Their cabinetry is superb, and
              their advice on best placements for kitchen furniture and
              appliances has meant that I can move through my kitchen with ease.
              I found the team working for this Company to be totally reliable.
              I was told the work (including building alternations) would take a
